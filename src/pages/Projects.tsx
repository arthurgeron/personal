  ...
  const projects = [
    {
      ...
      description: 'A plugin that helps developers write more efficient React components by properly using useMemo for performance optimization.',
    ...
    },
    {
      ...
      description: 'A library that enables efficient React Context API usage with native selector patterns.',
    ...
    },
    {
      id: 'web-crawler',
      title: 'Web Crawler',
      description: 'A customizable web crawler built in Python for gathering and analyzing web data.',
    ...
    },
    {
      id: 'eslint-config',
      title: 'ESLint Config',
      description: 'Custom ESLint configuration for React JS and React Native projects.',
  ...
  return (
    <div ref={containerRef} class="pt-24 pb-16">
      <div class="container-custom">
        <h1 class="text-4xl md:text-5xl font-bold mb-8 text-center text-gradient">My Projects</h1>
        <p class="text-lg text-center max-w-3xl mx-auto mb-12">
          Here are some of the projects I've worked on. Each represents my commitment to creating 
          tools and applications that solve real problems and improve developer experience.
        </p>
          ...
          <For each={categories}>
            {(category) => (
              <button
                ...
                classList={{
                  'bg-primary text-white': selectedCategory() === category || (category === 'All' && !selectedCategory()),
                  'bg-base-200 hover:bg-base-300': !(selectedCategory() === category || (category === 'All' && !selectedCategory())),
                }}
          ...
          <For each={filteredProjects()}>
            {(project) => (
              <div 
                ...
                classList={{
                  'transform -translate-y-2 shadow-xl': hoveredProject() === project.id,
              ...
              >
                <div class="p-6">
                  <div class="flex justify-between items-start mb-3">
                    ...
                    {project.featured && (
                      <span class="bg-primary/10 text-primary text-xs px-2 py-1 rounded">Featured</span>
                    )}
                  </div>
                  ...
                  <div class="flex flex-wrap gap-2 mb-6">
                    {project.technologies.map((tech) => (
                      <span class="px-2 py-1 bg-base-200 rounded-md text-xs">{tech}</span>
                    ))}
                  </div>
                  ...
                  <div class="flex items-center justify-between mt-auto">
                    ...
                    {project.stars && (
                      <div class="flex items-center text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4 text-warning mr-1">
